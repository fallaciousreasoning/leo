...
<Template let:args>
  <div
    style={`--leo-icon-color: ${args.color}; --leo-icon-size: ${args.size}px;`}
  >
    <Icon {...args} />
  </div>
</Template>
